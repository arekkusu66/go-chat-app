...
type CheckMessageUserRelationParams struct {
	UserID uuid.UUID          `json:"user_id"`
	ID     int64              `json:"id"`
	Kind   types.UserRelation `json:"kind"`
}

func (q *Queries) CheckMessageUserRelation(ctx context.Context, arg CheckMessageUserRelationParams) (bool, error) {
	row := q.db.QueryRowContext(ctx, checkMessageUserRelation, arg.UserID, arg.ID, arg.Kind)
	var exists bool
	err := row.Scan(&exists)
	return exists, err
}
...
func (q *Queries) CheckMutualRelation(ctx context.Context, arg CheckMutualRelationParams) (bool, error) {
	row := q.db.QueryRowContext(ctx, checkMutualRelation, arg.Kind, arg.UserID, arg.RelationUserID)
	var exists bool
	err := row.Scan(&exists)
	return exists, err
}
...
func (q *Queries) CheckRelation(ctx context.Context, arg CheckRelationParams) (bool, error) {
	row := q.db.QueryRowContext(ctx, checkRelation, arg.UserID, arg.RelationUserID, arg.Kind)
	var exists bool
	err := row.Scan(&exists)
	return exists, err
}
...
type CreateAuthVerificationParams struct {
	UserID uuid.UUID          `json:"user_id"`
	Kind   types.Verification `json:"kind"`
...
func (q *Queries) CreateRelation(ctx context.Context, arg CreateRelationParams) error {
	_, err := q.db.ExecContext(ctx, createRelation, arg.UserID, arg.RelationUserID, arg.Kind)
	return err
}
...
const deleteAllNotificationsByKind = `-- name: DeleteAllNotificationsByKind :exec
DELETE FROM notifications WHERE user_id = $1 AND kind = $2
`

type DeleteAllNotificationsByKindParams struct {
	UserID uuid.UUID `json:"user_id"`
	Kind   string    `json:"kind"`
}

func (q *Queries) DeleteAllNotificationsByKind(ctx context.Context, arg DeleteAllNotificationsByKindParams) error {
	_, err := q.db.ExecContext(ctx, deleteAllNotificationsByKind, arg.UserID, arg.Kind)
	return err
}
...
func (q *Queries) DeleteAuthVerification(ctx context.Context, arg DeleteAuthVerificationParams) error {
	_, err := q.db.ExecContext(ctx, deleteAuthVerification, arg.UserID, arg.Kind)
	return err
}
...
func (q *Queries) DeleteMutualRelation(ctx context.Context, arg DeleteMutualRelationParams) error {
	_, err := q.db.ExecContext(ctx, deleteMutualRelation, arg.Kind, arg.UserID, arg.RelationUserID)
	return err
}
...
func (q *Queries) DeleteRelation(ctx context.Context, arg DeleteRelationParams) error {
	_, err := q.db.ExecContext(ctx, deleteRelation, arg.UserID, arg.RelationUserID, arg.Kind)
	return err
}
...
SELECT id, message, date, link, kind, read, user_id, notif_from FROM notifications WHERE user_id = $1
`
...
func (q *Queries) GetAllRelations(ctx context.Context, arg GetAllRelationsParams) ([]User, error) {
	rows, err := q.db.QueryContext(ctx, getAllRelations, arg.UserID, arg.Kind)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
SELECT id, user_id, kind, token, expiry FROM auth_verification WHERE user_id = $1 AND kind = $2
`
...
func (q *Queries) GetAuthVerification(ctx context.Context, arg GetAuthVerificationParams) (AuthVerification, error) {
	row := q.db.QueryRowContext(ctx, getAuthVerification, arg.UserID, arg.Kind)
...
SELECT id, message, date, link, kind, read, user_id, notif_from FROM notifications WHERE id = $1
`
